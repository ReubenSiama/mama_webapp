...
<body>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <h4 style="background-color:#FD871F;padding:3px;margin-top: -20px;" class="text-center">CASH RECEIPT </h4> 
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="pull-right">
               ...
               <div style="padding-right: 55px;"> Cash Receipt Id : {{ $data->id }}<br>
              
               Date : {{ date('d F, Y', strtotime( $data->updated_at)) }}
                <br>
                 Name : {{$data->name}}<br>
                 Order Id : {{$data->order_id}}
                  <?php $project_id = DB::table('orders')->select('manu_id','project_id','main_category')->where('id',$data->order_id)->first(); 
                     if(count($project_id->manu_id == 0)){
                            $id = $project_id->project_id;

                     }else{

                        $id = $project_id->manu_id;
                     }
...
<div class="row">
	...
	<br><br><br><br><br>
                    ...
                    <tbody>
                       ...
                       <?php $i =1 ?>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-left"><b>Advance Amount Paid </b></td>
                            <td class="text-left"></td>
                            <td  class="text-left">{{ $data->Advance }}</td>
                        </tr>
                        <!-- <tr>
            ...
            <div class="row" style="margin-top:-50px;">
              ...
              <center  >  <b> Amount In Words</b> &nbsp;&nbsp;&nbsp; {{ $data->totalamountinwords}}  Only</center> 
            </div>
                     ...
                     <table class="table" border="1">
                       ...
                       <tbody>
                        ...
                        <tr>
                            <td  class="text-center">This is a computer generated Cash Receipt,based on the Full Payment we will Provide the Final Invoice</td>
                        </tr>
                    </tbody>
                </table>
            </div>
