...
@endphp
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <h4 style="background-color:#FD871F;padding:3px;margin-top: -20px;" class="text-center">TAX INVOICE</h4> 
            @if($data['mr'] != 1)  
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="pull-left">
                <b>BILL TO : </b><br>
                     ...
                     $name = App\MamahomePrice::where('invoiceno',$data['price']['invoiceno'])->pluck('customer_name')->first();
                        if($name==Null){
                     $names = DB::table('orders')->where('id',$data['price']['order_id'])->pluck('cid')->first();
                            if(count($names) > 0){
                    ...
                    ?><br>
                <b> GST : {{ $data['price']['customer_gst'] != null  ? $data['price']['customer_gst'] : 'N/A'}}</b>
            </div>
                ...
                <table class="table" border="1">
                    <thead >
                        <tr style="background-color:#e6e6e6">
                            ...
                            <th>HSN/SAC
                                 <?php $hsn = App\MamahomePrice::where('invoiceno',$data['id'])->pluck('HSN')->first(); 
