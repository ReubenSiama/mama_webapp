    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="pull-right">
               ...
               <div style="padding-right: 50px;">Quotation ID : {{ $data['price']->id }}<br>
                Date : {{ date('d F, Y') }}<br>
                ...
                <table class="table table-responsive" border=1>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <?php 
                               $quan = explode(",", $data['price']->multiquantity); 
                                  $s = count($quan);
                               ?>
                                @for($i=1;$i<=$s;$i++)
                                  {{$i}}<br>
                            ...
                            <td>
                                 <?php  
                               $product = explode(",", $data['price']->product); ?>
                         @foreach($product as $pro)
                            ...
                            <td>
                                 <?php 
                               $desc = explode(",", $data['price']->desct); ?>
                                 @foreach($desc as $proj)
                                   {{$proj}}<br>
                                 @endforeach
                            </td>
                            <td>
                            ...
                            <td colspan="2">
                                <?php 
                               $price = explode(",", $data['price']->price); ?>
                            ...
                            <td colspan="2">
                                <?php 
                               $total = explode(",", $data['price']->total); ?>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-left">{{ round($data['price']->totalmultiamount,2) }}</td>
                        </tr>
                        <!-- <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text-left">
                                ...
                                {{ round($data['price']->totalsgst,2) }}
                                
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="text-left">IGST({{$data['price']['igst']}}%)</td>
                            <td class="text-left"></td>
                            <td colspan="2" class="text-left">
                               
                                {{ round($data['price']->totaligst,2) }}
                        ...
                        <tr>
                            ...
                            <td class="text-left"></td>
                            <td colspan="2" class="text-left">{{ round($data['price']->withgstamount) }}</td>
                        </tr>
                        <tr>
                      ...
                      <tr class="clearfix">
                        ...
                        <tr>
                            <td colspan="9" class="text-center">This is a computer generated quotation</td>
                        </tr>
                    </tbody>
                </table>
            </div>
