    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="pull-right col-md-6">
                <b style="color:rgb(13, 187, 236);font-weight:bold;font-size:15px;">M R INFRASTRUCTURE DEVELOPERS</b>
    ...
    <div class="row">
           ...
           <div class="pull-right  col-md-6" style="padding-right: 30px; ">
                 <b>SHIP TO :</b><br>
                     ...
                     <?php 
                      $name=DB::table('m_r_supplierdetails')->where('order_id',$data['supplier']['order_id'])->pluck('customer_name')->first();
                     if($name==Null){
                        $names = DB::table('orders')->where('id',$data['supplier']['order_id'])->pluck('cid')->first();
                        if(count($names) > 0){
