...
@endphp
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <h4 style="background-color:#99ddff;padding:3px;margin-top: -20px;" class="text-center">PROFORMA INVOICE</h4> 
            <!-- @if($data['mr'] != 1)  
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
           ...
           <div class="pull-left">
                ...
                <br>
               No.363, 1st Floor, 19th Main Road,<br>
                 1st Block Rajajinagar, Bangalore, Bengaluru (Bangalore) Urban,<br> 
                Karnataka, 560010<br>
              ...
              Order ID : {{ $data['price']['order_id'] }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
                ...
                $pay1 = explode(", ",$data['products']->payment_mode);
                                      ...
                                      $pay = explode(",", $s);
                                        ...
                                        {{$pay}}
                                        @endif<br>    
                E-Way BillNo : {{$data['price']['e_way_no'] != null ? $data['price']['e_way_no'] : "N/A"}}  <br>
                Truck No : {{$data['price']['truckno_mr'] != null ? $data['price']['truckno_mr'] : "N/A" }}   
            </div>
            </div>
            @else
                <div class="pull-right">
       ...
       @if($data['mr'] != 1)
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="pull-right" style="padding-right: 20px;" >
                <b> Dispatch From :</b>
                    <br><b></b><br>
                    No 306/241,<br> 5th Cross Kadugodi Plantation Dinnur Village,<br> Whitefield Bangalore-560067
                ...
                <table class="table" border="1">
                    <thead >
                        <tr style="background-color:#e6e6e6">
                            ...
                            <th>HSN/SAC
                                 <?php $hsn = App\MRInvoice::where('invoiceno',$data['price']['invoiceno'])->pluck('HSN')->first(); 
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ round($data['price']['unitwithoutgst']) }}</td>
                            <td >{{ round($data['price']['totalamount']) }}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td  class="text-left">{{ round($data['price']['totalamount']) }}</td>
                        </tr>
                        <!-- <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-left"></td>
                            <td  class="text-left">{{ round($data['price']['amountwithgst'])}}</td>
                        </tr>
                        <tr>
