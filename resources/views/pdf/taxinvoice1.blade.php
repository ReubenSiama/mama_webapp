              ...
              Order ID : {{ $data['price']['order_id'] }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
                ...
                $pay1 = explode(", ",$data['products']->payment_mode);
                                        $pay1 = implode(" / ", $pay1);        
                                         ...
                                         $s = App\MultipleInvoice::where('invoiceno',$data['price']['invoiceno'])->pluck('paymentmode')->first();  
                                      $pay = explode(",", $s);
                                        ...
                                        @endif   
                <br>
                    E-Way BillNo : {{$data['price']['ewaynumber']}}
...
$su1 = App\MultipleInvoice::where('invoiceno',$data['price']['invoiceno'])->pluck('customergst')->first();  
                         ...
                         <tr class="clearfix">
                            <td colspan="9">
                                ...
                                <div class="pull-left  clearfix" style="padding-left:100px;">
                                     <b>Tax Amount In Words</b> &nbsp;&nbsp;&nbsp;  {{ $data['products']['totalamountinwords']}} Only
