    ...
    <div class="row">
            ...
            <div class="pull-left col-md-6" style="margin-left:15px;">
               <b> SUPPLIER NAME : </b><br>
                {{ $data['supplier']['sname']}}<br>
               <?php
                $address = $data['supplier']['bill'];
                echo wordwrap($address,45,"<br>\n");
                ?>
                    
                 <br><b>GST : {{ $data['supplier']['suppliergstgst'] }}</b><br>
            </div>
        ...
        <br><br><br><br><br><br><br>
            ...
            <div class="col-md-8 col-md-offset-2">
                <table class="table" border="2">
                    ...
                    <tbody>
                         <?php $cat = explode(",",$data['supplier']['category']);
                              ?> 
                            
                              <?php $subcat = explode(",",$data['supplier']['subcat']);
                              ?>
                       <?php $i =1 ?>
                        <tr>
                            ...
                            <td>
                                <?php $unit = explode(",",$data['supplier']['unit']);
                              ?> 
                               @foreach($unit as $ids)
                            ...
                            <td>
                                <?php $quantity = explode(",",$data['supplier']['quantity']);
                              ?> 
                            ...
                            @endforeach
                             ...
                             <td>
                                <?php $ppp = explode(",",$data['supplier']['price']);
                              ?> 
                               @foreach($ppp as $ids)
                            ...
                            <td colspan="2">
                                 <?php $unitprice = explode(",",$data['supplier']['unitprice']);
                              ?> 
                            ...
                            <td> <?php $withoutgst = explode(",",$data['supplier']['withoutgst']);
                              ?> 
                        ...
                        <tr>
                            ...
                            <td  class="text-left">{{ $data['supplier']['totalwithoutgst'] }}</td>
                        </tr>
                        <!-- <tr>
                        ...
                        <tr>
                            <?php 
                                   $st =explode(",",$data['supplier']['state']); 
                        ...
                        <td colspan="2" class="text-left">
                            ...
                            <td class="text-left"></td>
                            <td  class="text-left">
                                <?php  $f = ($data['supplier']['totalgst']/2); ?>
                              @if(count($gst->sgst) != 0)
                                   {{$f}}
                                   @else
                                   0
                        ...
                        <tr>
                            ...
                            <td class="text-left"></td>
                            <td  class="text-left">{{ $data['supplier']['totalwithgst']}}</td>
                        </tr>
                        <tr>
                            <td class="text-center" colspan="9">
                                <b> Amount In Words</b> &nbsp;&nbsp;&nbsp; {{ $data['supplier']['gstinwords']}}  Only
                            </td>
                        </tr>
                    </tbody>
                       <tr class="clearfix">
