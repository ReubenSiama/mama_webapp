...
@endphp
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <h4 style="background-color:#99ddff;padding:3px;margin-top: -20px;" class="text-center">TAX INVOICE</h4> 
            @if($data['mr'] != 1)  
        ...
        <div class="col-md-6 col-md-offset-3">
         ...
         <div class="pull-left">
            ...
            <div style="    text-align:center" >
                <b> Dispatach From :</b><br>
                   <!--  <br><b>{{ $data['manu'] == null ? $data['procurement']->procurement_name : $data['mprocurement']['name']}} </b><br> -->
                    <b> No 306/241</b><br>
                   5th Cross Kadugodi Plantation<br> Dinnur Village,
                   WhiteFeild <br>  Bangalore-560067
            </div>
        </div>
