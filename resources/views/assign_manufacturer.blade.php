    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default" style="border-color:#f4811f">
                <div class="panel-heading text-center" style="background-color:#f4811f"><b style="color:white;font-size:1.3em">Assign Manufacturers</b><b style="color:white;font-size:1.3em" class="pull-left"><a class="btn btn-primary btn-sm form-control" href="{{ URL::to('/') }}/resetallmanu"> Reset All</a></b>
                   @if(session('success'))
                    <script>
                          ...
                          @foreach($users as $user)  
                           ...
                           <td>{{date('d-m-Y', strtotime($user->data))  }}</td>
                             ...
                             <td><button onclick="makeUserId('{{ $user->id }}')" type="button" style="background-color: #00e676;color: white" data-toggle="modal" id="#myModal"  data-target="#myModal"  class="btn  pull-left">Assign</button></td>
                                  ...
                                  <form action="{{ URL::to('/') }}/resetmanu" method="post">
                                       {{ csrf_field() }}
                                        <input type="hidden" name="user_id" value="{{$user->id}}">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(244, 129, 31);padding:5px;color:white;">
            ...
            <h4 class="modal-title">Assign Manufacturers</h4>
      </div>
      <div class="modal-body">
        <div id="first">
        <div id="wards">  
          ...
          <div class="page">
            ...
            <div id="second" >
             ...
             <div class="row">
              ...
              <input style="width:40%;" type="date" name="assigndate" class="form-control input-sm datepicker" id="datepicker" placeholder="Select Date">
              </div>
         <div class="col-sm-6">
              ...
              <select style="width:40%;" class="form-control" name="type">
               ...
               <div class="col-sm-6">
               <h4 style="background-color:#9e9e9e;width: 50%; color:white;border: 1px solid gray;padding:5px;border-radius: 5px;">Select Manufacture Quality</h4>
