...
<table width='100%' cellpadding='0' cellspacing="0" ><tr><th width='90%'>&nbsp;</th></tr></table>
	<center><h3>Welcome to mamahome</H3></center>
<br>
	...
	{{ csrf_field() }} 	 
     <table width="600" cellpadding="2" cellspacing="2" border="0">
	   ...
	   <tr class="hidden">
            ...
            <td  align="left" width="50%"> <input name="account_id" type="text" value="25841"/><br><span><font color="red"> Please Enter your Account ID provided.</font></span> </td> 
        </tr>
        <tr class="hidden">
            <td class="fieldName" width="50%"><span class="error">*</span> Secret Key</td>
            <td  align="left" width="50%"> <input name="secretkey" type="text" value="da6a6a709fc32fa33eac44f3dc4321a1" size="35"/><br><span><font color="red"> Please Enter your Secret Key provided.</font></span></td>
        </tr>
	   <tr class="hidden">
        ...
        <tr>
            ...
            <td  align="left" width="50%"> <input name="amount" type="text" value="{{ $total }}" /> <select name="currency" >
