...
<div class="col-md-12">
  <span class="pull-right"> @include('flash-message')</span>
    <div class="panel panel-default" style="border-color:green;"> 
                <div class="panel-heading text-center" style="background-color: #5cb85c;color:white;padding:15px;"><b>Monthly Sales TP Details</b>
                  <div class="pull-left">
                  	<form action="{{ URL::to('/') }}/tpwithuser" method="GET">
                  ...
                  <th>TP(Without Gst)</th>
               	...
               	<tbody>
                       ...
                       <td>
                        ...
                        <a href="{{URL::to('/')}}/getmonthtpwithuserreport?year={{$finaldata['year']}}&&month={{$date['month']}}">
