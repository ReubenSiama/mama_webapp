...
<div class="container">
  ...
  <span class="pull-right"> @include('flash-message')</span>
        ...
        <form method="GET" action="{{ URL::to('/') }}/projects">
                    <div class="col-md-12">
                            <div class="col-md-3">
      ...
      <br>
      @if(count($data) > 0)
      <h3 style="text-align:center";> <span style="background-color:#777777;color:white;font-weight:bold;"> Total Customers {{$data->total()}} </span>  </h3>
      @endif
      <form action="{{URL::to('/')}}/storeproposedprojects" method="post" id="test1" >
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
           <form action="{{URL::to('/')}}/setgradeproject" method="post" id="yes">
                 {{ csrf_field() }} 
