    ...
    <div class="col-md-3">
        <div class="panel panel-primary" style="overflow-x:scroll">
            <div class="panel-heading text-center">
                <b style="color:white">Custom Manufacturer Update Report</b>
            </div>
            <div class="panel-body">
                <form action="{{ URL::to('/') }}/manuupdate" method="GET">
                     {{ csrf_field() }}
            ...
            <div class="panel-body" style="overflow-x:scroll;">
                <table class="table table-striped" border="1">
                    <thead>
                        ...
                        <th style="font-size: 10px;">Updated Manufacturer</th>
                        <th style="font-size: 10px;">Called Manufacturer</th>
                        <th style="font-size: 10px;">With Out Called Manufacturer</th>
                    </thead>
                ...
                <table class='table table-responsive table-striped' style="color:black" border="1">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center">Manufacturer Type</th>
                        ...
                        <tr>
                            ...
                            @foreach($sub as $subward)
                               ...
                               <td style="text-align:center" >
                                ...
                                {{ $subward->sub_ward_name != null ? $subward->sub_ward_name  : $y }}
                               </a>
                              </td>
                             @endif
                               @endforeach
                            <td style="text-align:center"><a href="{{ URL::to('/') }}/viewmanu?id={{  $activities->subject->id }}" target="_blank">{{ $activities->subject->id }}</a></td>
                              <?php $ibr=$activities->subject->id;
                            
                              $rat=App\Manufacturer::where('id',$ibr)->get()->pluck('manufacturer_type');
               ...
               @foreach($data['old'] as $key => $old)
                ...
                <td>  
                  ...
                  @endforeach
                              ...
                              <td style="text-align:center">
                                 @if($activities->called == 1)
                                 Yes
                                 @php $noOfCalledCount++ @endphp
                                 @else
                                 @php $unCalledCount++ @endphp
                                 No
                                 @endif      
                              </td>
                        </tr>
...
$(document).ready(function(){
    document.getElementById('counts').innerHTML = "<h4 style='margin-top:-10px;'>Total Manufacturer : " + {{ $noOfCalledCount + $unCalledCount }}+"&nbsp;&nbsp" + 
